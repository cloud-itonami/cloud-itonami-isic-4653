# Operator Quickstart — Wholesale of agricultural machinery, equipment and supplies

Shortest path from clone to a verified local dry-run for **ISIC 4653** (`cloud-itonami-isic-4653`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4653.git
cd cloud-itonami-isic-4653
```
...
- Blueprint governor key: `ag-equipment-governor`
- Likely source path: `agmachtrade.governor.cljc`
